...
<img src={user.image} style={{width:"30%",height:"30vh"}} className="rounded-circle" />

            </div>
            <div className="d-flex justify-content-evenly rounded">
              <h1 className="bg bg-warning mt-5 "> firstname:{user.firstName} </h1>
              <h1 className="bg bg-warning mt-5 "> lastname: {user.lastName} </h1>
            </div>
            <div className="d-flex justify-content-evenly rounded">
            ...
            <div className="d-flex justify-content-evenly rounded">
            <h1 className="bg bg-warning mt-5 "> password:{user.password} </h1>
              <h1 className="bg bg-warning mt-5 "> phoneNumber: {user.phoneNumber} </h1>
            </div>
            <div className="d-flex justify-content-evenly rounded">
